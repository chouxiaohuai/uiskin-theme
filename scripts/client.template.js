...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const SIDEBAR_CSS = [
      ...
      '.hHd-Xa_brand svg { flex: none; -webkit-mask-image: linear-gradient(to right, #000 0 60.6%, transparent 61%); mask-image: linear-gradient(to right, #000 0 60.6%, transparent 61%); }',
