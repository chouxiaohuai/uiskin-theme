...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const BASE_CSS = [
      ...
      '.pI_x6G_centerCol { position: relative; overflow: hidden; background-color: #c8dcf0; background-image: linear-gradient(rgba(5, 14, 34, 0.26), rgba(5, 14, 34, 0.26)), var(--ds-theme-bg-image); background-size: cover, cover; background-position: center, center; background-repeat: no-repeat, no-repeat; }',
